<div class="container mx-auto">
    ...
    <table class="min-w-full border-collapse border border-gray-400 mt-4">
        ...
        <tbody>
            ...
            <tr>
                <td class="py-2 px-4 border border-gray-300">{{ $ruang->id
}}</td>
                <td class="py-2 px-4 border border-gray-300">{{ $ruang->kode
}}</td>
                <td class="py-2 px-4 border border-gray-300">{{ $ruang->nama
}}</td>
...
$ruang->id }})" wire:confirm="Are you sure?">Delete</flux:button>
                </td>
            </tr>
            @endforeach
        </tbody>
